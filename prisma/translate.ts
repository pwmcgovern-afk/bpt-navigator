...
const translations: Record<string, { nameEs: string; descriptionEs: string; howToApplyEs?: string }> = {
  ...
  'Bridgeport Housing Authority (Elm City Communities)': {
    nameEs: 'Autoridad de Vivienda de Bridgeport (Elm City Communities)',
  ...
  'Neighborhood Housing Services of Bridgeport': {
    nameEs: 'Servicios de Vivienda del Vecindario de Bridgeport',
  ...
  'HOPWA Housing Assistance': {
    ...
    howToApplyEs: 'Contacte la Autoridad de Vivienda de la Ciudad de Bridgeport.'
  },

  // ===== FOOD =====
  'Connecticut Food Bank - Bridgeport': {
    nameEs: 'Banco de Alimentos de Connecticut - Bridgeport',
    descriptionEs: 'Distribución de alimentos a gran escala sirviendo agencias asociadas y despensas móviles de alimentos en el área metropolitana de Bridgeport.',
    howToApplyEs: 'Visite ctfoodbank.org/find-food para localizar una despensa cerca de usted.'
  },
  'Bridgeport Food Policy Council - Community Fridges': {
    nameEs: 'Consejo de Política Alimentaria - Refrigeradores Comunitarios',
    descriptionEs: 'Red de refrigeradores comunitarios en Bridgeport que proporcionan comida gratis las 24 horas, sin preguntas.',
  ...
  'Loaves & Fishes Food Pantry': {
    ...
    descriptionEs: 'Despensa de alimentos semanal que proporciona comestibles a residentes de Bridgeport necesitados.',
    howToApplyEs: 'Traiga identificación que muestre dirección en Bridgeport. Primer llegado, primer servido.'
  },
  ...
  'Community Action Agency of Bridgeport - Emergency Assistance': {
    nameEs: 'Agencia de Acción Comunitaria de Bridgeport - Asistencia de Emergencia',
  ...
  'General Assistance': {
    ...
    howToApplyEs: 'Aplique en la oficina de Servicios Sociales de Bridgeport.'
  },
  ...
  'Yale Bridgeport Hospital - Emergency Suboxone': {
    nameEs: 'Hospital Yale Bridgeport - Suboxone de Emergencia',
  ...
  'Yale Bridgeport Hospital - Financial Assistance': {
    nameEs: 'Hospital Yale Bridgeport - Asistencia Financiera',
  ...
  'BHcare Counseling': {
    ...
    descriptionEs: 'Servicios ambulatorios de salud mental y consejería de adicciones en el área metropolitana de Bridgeport.',
    howToApplyEs: 'Llame para cita de admisión.'
  },

  // ===== EMPLOYMENT =====
  'CTWorks Bridgeport': {
    nameEs: 'CTWorks Bridgeport',
  ...
  'Bridgeport Head Start': {
    nameEs: 'Head Start de Bridgeport',
    ...
    howToApplyEs: 'Aplique a través de las Escuelas Públicas de Bridgeport.'
  },
  'All Our Kin Family Childcare': {
    nameEs: 'Cuidado Infantil Familiar All Our Kin',
    descriptionEs: 'Red de proveedores de cuidado infantil familiar con licencia en Bridgeport, muchos aceptan subsidios Care 4 Kids.',
    howToApplyEs: 'Contacte para ayuda para encontrar un proveedor de cuidado infantil familiar.'
  },

  // ===== LEGAL AID =====
  'Bridgeport Legal Assistance Association': {
    nameEs: 'Asociación de Asistencia Legal de Bridgeport',
    descriptionEs: 'Servicios legales civiles gratuitos para residentes de bajos ingresos de Bridgeport, incluyendo vivienda, beneficios y derecho familiar.',
    howToApplyEs: 'Llame para evaluación de admisión.'
  },
  'Eviction Defense - Greater Bridgeport': {
    nameEs: 'Defensa contra Desalojos - Gran Bridgeport',
  ...
  'Greater Bridgeport Transit District': {
    nameEs: 'Distrito de Tránsito del Gran Bridgeport',
  ...
  'Bridgeport Elm City ID': {
    nameEs: 'Identificación Elm City de Bridgeport',
    descriptionEs: 'Tarjeta de identificación municipal para todos los residentes de Bridgeport sin importar el estatus migratorio. Aceptada para servicios de la ciudad.',
    howToApplyEs: 'Visite el Ayuntamiento con prueba de identidad y residencia en Bridgeport.'
  },
  ...
  'Community Soup Kitchen of Bridgeport': {
    nameEs: 'Comedor Comunitario de Bridgeport',
  ...
  'Christian Community Action Food Pantry': {
    ...
    descriptionEs: 'Despensa de alimentos que proporciona comestibles a familias necesitadas. Sirve a residentes de Bridgeport.',
    howToApplyEs: 'Traiga identificación y prueba de dirección en Bridgeport.'
  },
  ...
  'Salvation Army Bridgeport Food Pantry': {
    nameEs: 'Despensa de Alimentos del Ejército de Salvación Bridgeport',
  ...
  'St. Ann Food Pantry & Soup Kitchen': {
    ...
    descriptionEs: 'Despensa de alimentos y comedor que sirve al área metropolitana de Bridgeport.',
  ...
  'HAVEN Free Clinic': {
    ...
    descriptionEs: 'Clínica gratuita de atención primaria administrada por estudiantes para residentes de Bridgeport sin seguro. Atención integral sin costo.',
    howToApplyEs: 'Debe estar sin seguro y vivir en Bridgeport. Preséntese los sábados por la mañana.'
  },
  'Bridgeport Health Department - Health Center': {
    nameEs: 'Departamento de Salud de Bridgeport - Centro de Salud',
  ...
  'Project Access Bridgeport': {
    nameEs: 'Proyecto Acceso Bridgeport',
  ...
  'MCCA Bridgeport Outpatient': {
    nameEs: 'MCCA Bridgeport Ambulatorio',
  ...
  'American Job Center - Bridgeport': {
    nameEs: 'Centro de Empleo Americano - Bridgeport',
  ...
  'Bridgeport Works': {
    nameEs: 'Bridgeport Works',
    descriptionEs: 'Conecta a residentes de Bridgeport con buenos empleos. Proporciona servicios de capacitación laboral y colocación.',
  ...
  'LEAP - Leadership Education Athletics Partnership': {
    ...
    descriptionEs: 'Programas gratuitos de verano y después de la escuela para jóvenes de Bridgeport. Enriquecimiento académico, deportes y liderazgo.',
    howToApplyEs: 'Aplique en línea para programas de verano o después de la escuela.'
  },
  'CT Legal Services - Bridgeport': {
    nameEs: 'Servicios Legales de CT - Bridgeport',
  ...
  'Pitts Chapel Baptist Church Food Pantry': {
    ...
    descriptionEs: 'Despensa de alimentos de iglesia que sirve a la comunidad de Bridgeport.',
  ...
  'Omega SDA Church Community Service': {
    ...
    descriptionEs: 'Distribución mensual de alimentos que sirve a la comunidad de Bridgeport.',
    howToApplyEs: 'Preséntese durante las horas de distribución.'
  },
  ...
  'Trinity Community Grants Program': {
    ...
    descriptionEs: 'Financiamiento de subvenciones para programas de servicios humanos que abordan salud, hambre, refugio y educación en Bridgeport.',
  ...
  'St. Vincent de Paul Society - Bridgeport': {
    nameEs: 'Sociedad de San Vicente de Paúl - Bridgeport',
  ...
  'Jewish Family Service of Greater Bridgeport': {
    nameEs: 'Servicio Familiar Judío del Gran Bridgeport',
