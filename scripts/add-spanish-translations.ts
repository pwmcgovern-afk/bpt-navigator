...
const translations: Record<string, { descriptionEs: string; howToApplyEs?: string }> = {
  'Neighborhood Housing Services of Bridgeport': {
    descriptionEs: 'Organización sin fines de lucro que ayuda a residentes de Bridgeport a comprar, mantener y mejorar sus hogares. Ofrece asesoría de vivienda, préstamos para reparaciones del hogar y programas de compradores por primera vez.',
  ...
  'Bridgeport Food Policy Council - Community Fridges': {
    descriptionEs: 'Refrigeradores comunitarios ubicados en Bridgeport donde cualquiera puede tomar o dejar comida gratis. Disponible 24/7, sin preguntas.',
    howToApplyEs: 'Solo acérquese - no se requiere registro.'
  },
  'Loaves & Fishes Food Pantry': {
    descriptionEs: 'Despensa de alimentos que sirve a familias e individuos necesitados en Bridgeport. Proporciona comestibles y artículos básicos.',
  ...
  'Varick AME Zion Church Food Pantry': {
    descriptionEs: 'Despensa de alimentos basada en la iglesia que sirve a la comunidad de Bridgeport. Proporciona comestibles y comidas calientes.',
  ...
  'Macedonia Church Food Pantry': {
    descriptionEs: 'Despensa de alimentos basada en la iglesia que proporciona comestibles a familias necesitadas en Bridgeport.',
    howToApplyEs: 'Visite durante las horas de distribución.'
  },
  'Community Baptist Church Mobile Food Pantry': {
    descriptionEs: 'Despensa móvil de alimentos que lleva productos frescos y comestibles a vecindarios de Bridgeport.',
    howToApplyEs: 'Revise el horario de ubicaciones y visite.'
  },
  'Hillside Family Shelter': {
    descriptionEs: 'Refugio de emergencia para familias sin hogar en Bridgeport. Proporciona vivienda temporal y servicios de apoyo.',
  ...
  'Bridgeport Works': {
    descriptionEs: 'Programa de capacitación laboral y empleo que conecta a residentes de Bridgeport con empleos locales y capacitación.',
  ...
  'LEAP - Leadership Education Athletics Partnership': {
    descriptionEs: 'Programas después de la escuela y de verano para niños y jóvenes de Bridgeport. Proporciona enriquecimiento académico, deportes y mentoría.',
  ...
  'Moved With Compassion Ministry': {
    descriptionEs: 'Ministerio de alcance que proporciona alimentos, ropa y apoyo a los necesitados en Bridgeport.',
    howToApplyEs: 'Contacte el ministerio para información.'
  },
  'Mount Hope Temple Food Pantry': {
    descriptionEs: 'Despensa de alimentos del templo que sirve comestibles a familias de Bridgeport.',
    howToApplyEs: 'Visite durante las horas de distribución.'
  },
  ...
  "St. Matthew's Unison Freewill Baptist Food Pantry": {
    descriptionEs: 'Despensa de alimentos de la iglesia que sirve a la comunidad de Bridgeport.',
    howToApplyEs: 'Visite durante las horas de distribución.'
  },
  ...
  'St. Rose of Lima Church - Food Pantry': {
    descriptionEs: 'Despensa de alimentos de la iglesia católica que sirve a la comunidad de Bridgeport.',
    howToApplyEs: 'Visite durante las horas de la despensa.'
  },
