...
const resourceUpdates: Record<string, {
  ...
  'Cornell Scott-Hill Health Center - Primary Care': {
    ...
    descriptionEs: 'Centro de salud comunitario que sirve a Bridgeport desde 1968. Ofrece atención primaria con tarifas escalonadas.',
  ...
  'Bridgeport Housing Authority (Elm City Communities)': {
    ...
    descriptionEs: 'Autoridad de vivienda de Bridgeport. Administra vivienda pública y vales de la Sección 8.',
  ...
  'Bridgeport Elm City ID': {
    tips: [
      'Available to all Bridgeport residents regardless of immigration status',
    ...
    tipsEs: [
      'Disponible para todos los residentes de Bridgeport sin importar el estatus migratorio',
    ...
    descriptionEs: 'Tarjeta de identificación municipal disponible para todos los residentes de Bridgeport.',
