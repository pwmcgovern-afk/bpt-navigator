...
const newResources = [
  // SENIOR SERVICES
  {
    name: 'Bridgeport Elderly Services',
    nameEs: 'Servicios para Personas Mayores de Bridgeport',
  ...
  },
  {
    ...
    organization: 'AOASCC',
    description: 'Non-profit serving older adults, individuals with disabilities, and caregivers in greater Bridgeport. Provides information, referrals, and direct services including Medicare counseling, caregiver support, long-term care planning, and connections to home-based services.',
    descriptionEs: 'Organización sin fines de lucro que sirve a adultos mayores, personas con discapacidades y cuidadores en el área de Bridgeport. Proporciona información, referencias y servicios directos incluyendo asesoramiento de Medicare y apoyo a cuidadores.',
    categories: ['healthcare'],
  ...
  // YOUTH SERVICES
  {
    ...
    tips: [
      ...
      'GED classes are offered in partnership with Bridgeport Adult Ed'
    ],
    tipsEs: [
  ...
  },
  {
    ...
    organization: 'City of Bridgeport',
    description: 'Summer work-based learning program providing Bridgeport Public School students ages 14-21 with paid workplace experience, mentoring, and enrichment activities. Typically runs July through August.',
    descriptionEs: 'Programa de aprendizaje basado en el trabajo de verano que proporciona a estudiantes de las Escuelas Públicas de Bridgeport de 14-21 años experiencia laboral pagada, mentoría y actividades de enriquecimiento.',
    ...
    howToApply: 'Applications open in spring each year. Must be enrolled in Bridgeport Public Schools.',
    howToApplyEs: 'Las solicitudes abren en primavera cada año. Debe estar inscrito en las Escuelas Públicas de Bridgeport.',
    tips: [
  ...
  },
  {
    ...
    howToApply: 'Referrals come through Bridgeport schools. Parents can also contact the Youth Services Bureau.',
    howToApplyEs: 'Las referencias vienen a través de las escuelas de Bridgeport. Los padres también pueden contactar la Oficina de Servicios Juveniles.',
    tips: [
  ...
  {
    name: 'Bridgeport Free Public Library - Teen Center',
    nameEs: 'Biblioteca Pública de Bridgeport - Centro para Adolescentes',
    organization: 'Bridgeport Free Public Library',
  ...
  {
    name: 'Bridgeport Disability Services',
    nameEs: 'Servicios de Discapacidad de Bridgeport',
    organization: 'City of Bridgeport',
  ...
  // EDUCATION
  {
    name: 'Bridgeport Adult & Continuing Education',
    nameEs: 'Educación de Adultos y Continua de Bridgeport',
  ...
  {
    name: 'Bridgeport Job Corps Center',
    nameEs: 'Centro Job Corps de Bridgeport',
  ...
  // EMPLOYMENT
  {
    ...
    organization: 'A4TD',
    description: 'Free virtual job skills training for low-income Bridgeport County residents age 55+. Focuses on high-demand jobs in food service and healthcare. Provides laptops and internet access to participants.',
    descriptionEs: 'Capacitación gratuita virtual de habilidades laborales para residentes de bajos ingresos del Condado de Bridgeport de 55+ años. Se enfoca en trabajos de alta demanda en servicio de alimentos y atención médica.',
