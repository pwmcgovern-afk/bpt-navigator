...
const resourceUpdates: Record<string, {
  ...
  'Loaves and Fishes - St. Paul & St. James Church': {
    tips: [
      'One of Bridgeport\'s longest-running food ministries - trusted for over 40 years',
    ...
    tipsEs: [
      'Uno de los ministerios de alimentos más antiguos de Bridgeport - más de 40 años',
  ...
  'Bridgeport Home Recovery - Abraham\'s Tent': {
    tips: [
  ...
  'Cornell Scott-Hill Health Center - Congress Avenue': {
    ...
    descriptionEs: 'Centro de salud comunitario que sirve a la comunidad de Bridgeport desde 1968. Ofrece atención primaria, dental, salud mental y más.',
  ...
  // ===== HARM REDUCTION =====
  'Bridgeport Syringe Services Program': {
    tips: [
  ...
  'Career Resources Inc.': {
    ...
    descriptionEs: 'Centro de empleo que ofrece capacitación laboral, colocación y servicios de carrera para residentes de Bridgeport.',
  ...
  // ===== LEGAL =====
  'Bridgeport Legal Assistance': {
    tips: [
      'Free legal help for low-income Bridgeport residents',
    ...
    tipsEs: [
      'Ayuda legal gratuita para residentes de bajos ingresos de Bridgeport',
  ...
  'Elm City Communities (Housing Authority)': {
    ...
    descriptionEs: 'Autoridad de vivienda de Bridgeport. Administra vivienda pública y vales de la Sección 8 para familias de bajos ingresos.',
  ...
  'Department of Social Services (DSS) - Bridgeport': {
    tips: [
  ...
  'Beulah Heights Social Integration Program': {
    tips: [
      ...
      'Van picks up from Bridgeport Green - check the schedule',
    ...
    tipsEs: [
      ...
      'La camioneta recoge desde el Bridgeport Green - consulte el horario',
