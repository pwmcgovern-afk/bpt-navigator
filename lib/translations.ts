...
export const translations = {
  en: {
    ...
    // Home page
    welcomeTitle: 'Bridgeport Navigator',
    welcomeSubtitle: 'Find resources and services in Bridgeport',
    ...
    // Footer
    madeFor: 'Made for the Bridgeport community',
    ...
    chatWelcome: 'Hi! I can help you find social services in Bridgeport. What kind of help are you looking for?',
  ...
  es: {
    ...
    // Home page
    welcomeTitle: 'Navegador de Bridgeport',
    welcomeSubtitle: 'Encuentre recursos y servicios en Bridgeport',
    ...
    // Footer
    madeFor: 'Hecho para la comunidad de Bridgeport',
    ...
    chatWelcome: '¡Hola! Puedo ayudarle a encontrar servicios sociales en Bridgeport. ¿Qué tipo de ayuda necesita?',
