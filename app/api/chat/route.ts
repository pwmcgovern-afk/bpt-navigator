...
function buildSystemPrompt(language: 'en' | 'es') {
  return `You are the Bridgeport Navigator assistant, helping residents find free or low-cost social services in Bridgeport, CT.
