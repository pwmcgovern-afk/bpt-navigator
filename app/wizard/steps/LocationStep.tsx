...
import { BRIDGEPORT_ZIPS } from '@/lib/constants'
  ...
  return (
    <section aria-labelledby="location-title">
      ...
      <input
        ...
        aria-describedby={data.zipCode.length === 5 && !BRIDGEPORT_ZIPS.includes(data.zipCode) ? 'zip-warning' : undefined}
      />
      {data.zipCode.length === 5 && !BRIDGEPORT_ZIPS.includes(data.zipCode) && (
