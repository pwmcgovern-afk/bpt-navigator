...
export const wizardContent = {
  en: {
    ...
    locationWarning: "This zip code is outside Bridgeport. Some resources may not apply.",
  ...
  es: {
    ...
    locationWarning: 'Este código postal está fuera de Bridgeport. Algunos recursos pueden no aplicar.',
