    ...
    <div className="min-h-screen">
      ...
      <main className="px-5 pb-12 editorial-prose" style={{ color: 'var(--color-text)' }} role="main" id="main-content">
        ...
        <section>
          ...
          <p>{isEs
            ? 'Bridgeport Navigator es un directorio comunitario gratuito de servicios sociales para los residentes del área de Bridgeport, CT. No es una agencia gubernamental y no está afiliado a ningún proveedor de servicios listado.'
            : 'Bridgeport Navigator is a free community directory of social services for residents of the greater Bridgeport, CT area. It is not a government agency and is not affiliated with any listed service provider.'
          }</p>
        </section>
