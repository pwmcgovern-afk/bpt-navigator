  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="px-5 py-8 prose prose-sm max-w-none" style={{ color: 'var(--color-text)' }}>
        ...
        <p>{isEs
          ? 'Bridgeport Navigator es un directorio comunitario gratuito de servicios sociales para los residentes del area de Bridgeport, CT. No es una agencia gubernamental y no esta afiliado a ningun proveedor de servicios listado.'
