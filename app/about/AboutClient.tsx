...
const copy = {
  en: {
    ...
    sistersBody: 'Navigator also runs in New Haven and Hartford, with the same approach: a free, bilingual directory of local resources, an AI assistant grounded in real listings, and an eligibility quiz.',
    sistersNhv: 'New Haven Navigator',
    sistersHfd: 'Hartford Navigator',
  ...
  es: {
    ...
    title: 'Acerca de Bridgeport Navigator',
    lede: 'Un directorio gratuito y bilingüe de servicios sociales en Bridgeport — creado para que los residentes encuentren ayuda en minutos, no en horas.',
    whySection: 'Por qué existe',
    whyBody:
      'Si busca ayuda con el alquiler, comida o atención médica en Bridgeport, la respuesta normalmente implica llamar al 211, esperar en un menú telefónico y confiar en que el consejero conozca la agencia adecuada. La información está dispersa en sitios web, PDFs del 211 y el boca a boca. Los hispanohablantes lo tienen peor — la mayoría de los directorios existentes solo están en inglés.',
    ...
    sistersBody: 'Navigator también funciona en New Haven y Hartford, con el mismo enfoque: un directorio gratuito y bilingüe de recursos locales, un asistente de IA basado en listados reales y un cuestionario de elegibilidad.',
    sistersNhv: 'New Haven Navigator',
    sistersHfd: 'Hartford Navigator',
      ...
      <main className="px-5 py-8" role="main" id="main-content">
        ...
        <section className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="https://www.hfdnavigator.com"
              target="_blank"
              rel="noreferrer"
              className="card-flat flex-1 hover:border-[var(--color-primary)] transition-colors"
            >
              <span className="font-semibold block">{t.sistersHfd}</span>
              <span className="text-xs" style={{ color: 'var(--color-text-muted)' }}>hfdnavigator.com</span>
            </a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p>
            ...
            {t.whoBody2}{' '}
            <a
              href="https://github.com/pwmcgovern-afk/bpt-navigator"
              target="_blank"
              rel="noreferrer"
