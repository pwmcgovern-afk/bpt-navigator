  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="px-5 py-8 prose prose-sm max-w-none" style={{ color: 'var(--color-text)' }}>
        ...
        <p>{isEs
          ? 'Bridgeport Navigator esta disenado para proteger su privacidad. NO recopilamos informacion personal identificable (PII) como nombre, email, numero de telefono o direccion.'
