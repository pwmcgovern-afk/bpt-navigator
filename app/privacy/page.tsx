    ...
    <div className="min-h-screen">
      ...
      <main className="px-5 pb-12 editorial-prose" style={{ color: 'var(--color-text)' }} role="main" id="main-content">
        ...
        <section>
          ...
          <p>{isEs
            ? 'Bridgeport Navigator está diseñado para proteger su privacidad. NO recopilamos información personal identificable (PII) como nombre, email, número de teléfono o dirección.'
            : 'Bridgeport Navigator is designed to protect your privacy. We do NOT collect personally identifiable information (PII) such as your name, email, phone number, or address.'
          }</p>
